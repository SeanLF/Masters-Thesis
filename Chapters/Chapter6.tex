...
\section{Future Work}
Our framework took very little execution time, far below that of current state of the art techniques, and achieved comparable predictive accuracy, while also using 20\% fewer labelled instances for training, and 100\% less for detecting drifts. We believe that higher predictive accuracy can be achieved, and by using even less labelled data, without significantly impacting the execution time.
